...
def simulate_cpu_spike(duration=30, cpu_percent=75):
...
if __name__ == '__main__':
    # Simulate a CPU spike for 30 seconds with 75% CPU utilization
    simulate_cpu_spike(duration=30, cpu_percent=75)
